<?php /* Template Name: Archive Productors */ ?>
			...
			<div id="content" class="container">
				...
				<div id="inner-content" class="wrap cf">
						...
						<main id="main-tag" class="m-all t-2of3 d-5of7 cf" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
							...
							<?php
							the_archive_description( '<div class="productor-tag-description">', '</div>' );
							?>
		<div class="posts">				
							<?php if (have_posts()) : while (have_posts()) : the_post(); ?>


							<article id="post-<?php the_ID(); ?>" class="tag-post-wrapper post-wrapper <?php if (get_field("important")){echo "imp";} ?>"<?php post_class( 'prodet' ); ?> role="article">
