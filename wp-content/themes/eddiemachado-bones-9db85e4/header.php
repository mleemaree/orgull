...
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/style.css">
	...
	<body <?php body_class(); ?>>
        ...
        <li><a href="https://www.facebook.com/ores/" id="facebook"><object style="pointer-events:none;"data="<?php echo get_template_directory_uri(); ?>/library/images/facebook-im.svg" type="image/svg+xml"></object></a></li>
        <li><a href="https://www.facebook.com/ogullpages/" class="has-svg" >
        ...
        <li><a href="https://www.facebook.com/dkldjlkdlkjd/" class="has-svg" ><object data="<?php echo get_template_directory_uri(); ?>/library/images/instagram.svg" type="image/svg+xml"></object></a></li>       
    </div>
